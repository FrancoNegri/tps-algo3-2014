...
do
    ...
    ./$DIR/tester 250 31125 70
    for equis in {1..11}
    do
        #echo "Compilando Codigo con x =" $equis
        g++ -O2 -std=c++0x Ej5/ej5A.cpp -D PORCENTAJEDEMEJORES=10 -D CANTIDADDEEXITOS=$(( 10^	$equis )) -o $DIR/G1
        g++ -O2 -std=c++0x Ej5/ej5B.cpp -D PORCENTAJEDEMEJORES=10 -D CANTIDADDEEXITOS=$(( 10^$equis )) -o $DIR/G2
        #g++ -O2 -std=c++0x Ej5/ej5C.cpp -D PORCENTAJEDEMEJORES=10 -D CANTIDADDEEXITOS=$(( $equis*10 )) -o $DIR/G3
        #echo "OK!"
