...
echo "Compilando Codigo..."
 g++ -O2 -std=c++0x generadorDeGrafosUniformes.cpp -o $DIR/generador_de_entrada
...
for numeroDeNodos in {3..50}
do
    echo "generada entrada para n:" $(( (10*$numeroDeNodos) ))
    ./$DIR/generador_de_entrada  $(( (10*$numeroDeNodos) ))  $(( (10*$numeroDeNodos) * ((10*$numeroDeNodos) - 1) / 2  )) 5
...
paste $DIR/tiempos2.txt $DIR/tiempos3.txt $DIR/tiempos4.txt $DIR/tiempos7.txt  > $DIR/Performance

# #copio todos las performances (resultados) en un solo lugar

paste $DIR/performanece2.txt $DIR/performanece3.txt $DIR/performanece4.txt $DIR/performanece7.txt > $DIR/Tiempo
