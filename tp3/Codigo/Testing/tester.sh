...
for numeroDeNodos in {25..100}
do
    echo "generada entrada para n:" $(( $numeroDeNodos ))
    for j in {1..100}
    do
        ./$DIR/tester  $(( $numeroDeNodos ))  $(( $numeroDeNodos * ($numeroDeNodos - 1) / 2  )) 5
	   #./$DIR/ej2 < $DIR/test.txt >> $DIR/resultados2.txt
        ...
        echo "" >> $DIR/resultados4.txt
        echo "" >> $DIR/resultados5.txt
        echo "" >> $DIR/resultados6.txt
        echo "" >> $DIR/resultados7.txt
        echo "" >> $DIR/resultados8.txt
done
...
# paste $DIR/tiempos2.txt $DIR/tiempos3.txt $DIR/tiempos4.txt $DIR/tiempos5.txt $DIR/tiempos6.txt $DIR/tiempos7.txt $DIR/tiempos8.txt  > $DIR/TIEMPOS

# #copio todos las performances (resultados) en un solo lugar

# paste $DIR/performanece2.txt $DIR/performanece3.txt $DIR/performanece4.txt $DIR/performanece5.txt $DIR/performanece6.txt $DIR/performanece7.txt $DIR/performanece8.txt  > $DIR/PERFORMANCE
