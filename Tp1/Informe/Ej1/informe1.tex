...
>>>>>>> e04b514a32f790be71f01e5c1eb8236c4cdc0a05
...
Luego para demostrar por absurdo, supongamos que no es así. Dicho mas formalmente, existe una sucesión $V=\{v_1,v_2,...,v_i\}$ de saltos tal que es menor a la sucesión $W= \{w_1,w_2,...,w_i, w_{i+1},...,w_j\}$ que encuentra nuestro algoritmo.

Por condiciones del problema sabemos el tablón al que queremos saltar no puede estar a distancia mayor a $k$ (el salto máximo posible), esto significa que:
=======
