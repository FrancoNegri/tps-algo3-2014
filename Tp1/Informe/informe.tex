...
\begin{document}
    ...
    \grupo{}
    \integrante{Ricardo Colombo}{156/08}{a@a.com}
    \integrante{Federico Suarez}{610/11}{a@a.com}
    \integrante{Juan Carlos Giudici}{827/06}{elchudi@gmail.com}
    \integrante{Franco Negri}{000/00}{a@a.com}
...
\chapter{Puentes sobre lava caliente}  \input{./Ej1/informe1.tex}

\chapter{Horizontes lejanos}  \input{./Ej2/informe2.tex}

\chapter{Biohazard}  \input{./Ej3/informe3.tex}
